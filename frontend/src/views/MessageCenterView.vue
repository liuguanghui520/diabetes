...
<template>
    <div class="page message-page">
        <header class="message-header">
            <button class="back-button" aria-label="返回个人中心" @click="goBack">
                <el-icon>
                    <ArrowLeft />
                </el-icon>
            </button>
        ...
        <section class="message-tip">
            ...
            <p>
                消息提醒用于展示风险评估、方案打卡和复查任务状态；后续将由 Express 接口统一推送。
            </p>
        </section>
        ...
        >
            <section class="message-dialog">
                <div class="dialog-top">
                    ...
                    <button aria-label="关闭消息详情" @click="closeMessage">×</button>
                </div>
                ...
                <div class="dialog-actions">
                    <button class="dialog-close" aria-label="关闭消息详情" @click="closeMessage">
                        知道了
                    </button>
