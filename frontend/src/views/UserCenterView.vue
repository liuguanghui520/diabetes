...
function showComingSoon(text) {
    ElMessage.info(`${text}将在后续 Express 接口联调后开放`)
}
    ...
    <div class="page profile-page">
        ...
        <section class="service-section">
            ...
            <div class="cell-group">
                ...
                <button class="cell-item" @click="goHealth">
                    ...
                    <span class="cell-label">健康数据分析</span>
        ...
        <section class="service-section">
            ...
            <div class="cell-group">
                ...
                <button class="cell-item" @click="goMessages">
                    <span class="cell-icon blue">
                        <el-icon>
                            <ChatDotRound />
                        </el-icon>
                    ...
                    <span class="cell-label">消息中心</span>

                    <span class="cell-desc">3 条未读</span>
